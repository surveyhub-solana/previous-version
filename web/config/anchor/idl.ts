...
export const IDL: Idl = {
  ...
  instructions: [
    ...
    {
      name: 'updateFormToken',
      accounts: [
        { name: 'form', isMut: true, isSigner: false },
        { name: 'owner', isMut: true, isSigner: true },
        { name: 'system', isMut: true, isSigner: true },
        { name: 'mint', isMut: false, isSigner: false },
        { name: 'systemTokenAccount', isMut: true, isSigner: false },
    ...
    },
    {
      ...
      accounts: [
        ...
        { name: 'system', isMut: true, isSigner: true },
        { name: 'systemTokenAccount', isMut: true, isSigner: false },
        { name: 'authorTokenAccount', isMut: true, isSigner: false },
        { name: 'systemProgram', isMut: false, isSigner: false },
        { name: 'tokenProgram', isMut: false, isSigner: false },
        { name: 'associatedTokenProgram', isMut: false, isSigner: false },
        { name: 'rent', isMut: false, isSigner: false },
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          { name: 'mint', type: { option: 'publicKey' } },
        ],
      },
    },
  ],
